...
class Page(models.Model):
    ...
    is_published = models.BooleanField(
        default=False,
        help_text='Este campo deverá estar marcado para a página ser exibida publicamente.'
    )
...
class Post(models.Model):
    ...
    is_published = models.BooleanField(
        default=False,
        help_text='Este campo deverá estar marcado para o Post ser exibido publicamente.',
    )
    content = models.TextField()
    ...
    cover_description = models.CharField(max_length=65, null=True)
